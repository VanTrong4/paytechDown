              ...
              <tr>
                ...
                <td>
                  <div class="form-group">
                    <input type="date" id="register_date" name="register_date" value="{{ old('register_date', $customer->register_date->format('Y-m-d')) }}" class="form-control @error('register_date') is-invalid @enderror" required>
                    @error('register_date')
